...
export const translations = {
    en: {
        ...
        trips: {
            title: "Trips & Tips",
            subtitle: "Discover the best hiking trails and local recommendations in the area",
            addButton: "+ Add New Trip",
            by: "by",
            map: "Map",
            delete: "Delete",
            edit: "Edit",
        ...
        tripForm: {
            ...
            author: "Author:",
            mapUrl: "URL to route:",
            mapUrlPlaceholder: "e.g., https://mapy.cz/s/...",
            length: "Length (km):",
            ...
            typeBike: "Bike",
            typeAttraction: "Attraction",
            startFromMoggio: "Start from Moggio:",
            startYes: "Yes",
            startNo: "No (need car)",
            driveTime: "Drive Time (min):",
            driveTimePlaceholder: "0 if from Moggio",
            description: "Description:",
            photos: "Trip Photos (up to 10):",
            submit: "Add Trip"
        },
        gallery: {
            title: "Photo Gallery",
        ...
        messages: {
            ...
            tripSaveError: "An error occurred while adding the trip. Please try again.",
            ...
            filesTooLarge: "Images are too large. Maximum file size is 100MB per image. Please compress or resize your images.",
            tooManyFiles: "Too many files. You can upload a maximum of 10 images per trip.",
            payloadTooLarge: "Request is too large. Please reduce the number or size of images.",
    ...
    cz: {
        ...
        tripForm: {
            ...
            startYes: "Ano",
            startNo: "Ne (potřeba auto)",
            driveTime: "Doba jízdy (min):",
            driveTimePlaceholder: "0 pokud z Moggia",
            description: "Popis:",
            photos: "Fotografie výletu (max 10):",
            submit: "Přidat výlet"
        },
        gallery: {
            title: "Fotogalerie",
        ...
        bucketListForm: {
            ...
            editTitle: "Upravit položku seznamu",
            name: "Název položky:",
            description: "Popis:",
            url: "URL (volitelné):",
        ...
        messages: {
            ...
            tripSaveError: "Při přidávání výletu došlo k chybě. Zkuste to znovu.",
            ...
            filesTooLarge: "Obrázky jsou příliš velké. Maximální velikost souboru je 100MB na obrázek. Zkomprimujte nebo zmenšete obrázky.",
            tooManyFiles: "Příliš mnoho souborů. Můžete nahrát maximálně 10 obrázků na výlet.",
            payloadTooLarge: "Požadavek je příliš velký. Snižte počet nebo velikost obrázků.",
...
export function renderLanguageToggle() {
    const leftActions = document.querySelector('.header-actions:first-child');
    if (!leftActions) return;

    const currentLang = getCurrentLanguage();

    const czStyle = currentLang === 'cz'
    ...
    leftActions.innerHTML = `
        <a href="#" id="lang-cz" style="text-decoration:none;font-family:'Courier New',monospace;font-size:11px;padding:2px 8px;border:1px solid #084d29;${czStyle}">CZ</a>
        <a href="#" id="lang-en" style="text-decoration:none;font-family:'Courier New',monospace;font-size:11px;padding:2px 8px;border:1px solid #084d29;${enStyle}">EN</a>
    `;

    document.getElementById('lang-cz').onclick = (e) => {
        e.preventDefault();
        setLanguage('cz');
    };

    document.getElementById('lang-en').onclick = (e) => {
        e.preventDefault();
        setLanguage('en');
    };
}
